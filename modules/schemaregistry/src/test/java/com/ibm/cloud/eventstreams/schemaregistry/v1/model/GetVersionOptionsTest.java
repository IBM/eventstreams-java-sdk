...
/**
 * Unit test class for the GetVersionOptions model.
 */
public class GetVersionOptionsTest {
  ...
  @Test
  public void testGetVersionOptions() throws Throwable {
    GetVersionOptions getVersionOptionsModel = new GetVersionOptions.Builder()
      .id("testString")
      .version(Long.valueOf("26"))
      .build();
    assertEquals(getVersionOptionsModel.id(), "testString");
    assertEquals(getVersionOptionsModel.version(), Long.valueOf("26"));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetVersionOptionsError() throws Throwable {
    new GetVersionOptions.Builder().build();
  }
