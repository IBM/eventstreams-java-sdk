...
public class CreateSchemaOptionsTest {
  ...
  public void testCreateSchemaOptions() throws Throwable {
    CreateSchemaOptions createSchemaOptionsModel = new CreateSchemaOptions.Builder()
      ...
      .build();
    assertEquals(createSchemaOptionsModel.schema(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    assertEquals(createSchemaOptionsModel.xRegistryArtifactId(), "testString");
  }
}