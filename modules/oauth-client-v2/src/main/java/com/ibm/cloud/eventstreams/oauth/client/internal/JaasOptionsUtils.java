...
/**
 * JaasOptionsUtils is a utility class to perform logic for the JAAS options.
 * This is a simplified version containing only methods used by the oauth-client.
 */
