...
/**
 * Unit test class for the DeleteQuotaOptions model.
 */
public class DeleteQuotaOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteQuotaOptions() throws Throwable {
    DeleteQuotaOptions deleteQuotaOptionsModel = new DeleteQuotaOptions.Builder()
      .entityName("testString")
      .build();
    assertEquals(deleteQuotaOptionsModel.entityName(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteQuotaOptionsError() throws Throwable {
    new DeleteQuotaOptions.Builder().build();
  }
