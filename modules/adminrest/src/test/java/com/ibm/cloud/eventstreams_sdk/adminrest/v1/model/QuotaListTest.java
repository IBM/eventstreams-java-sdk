...
/**
 * Unit test class for the QuotaList model.
 */
public class QuotaListTest {
  ...
  @Test
  public void testQuotaList() throws Throwable {
    QuotaList quotaListModel = new QuotaList();
    assertNull(quotaListModel.getData());
  }
}