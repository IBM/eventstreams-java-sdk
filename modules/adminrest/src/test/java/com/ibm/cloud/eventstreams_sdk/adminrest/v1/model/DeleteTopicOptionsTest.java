...
/**
 * Unit test class for the DeleteTopicOptions model.
 */
public class DeleteTopicOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteTopicOptions() throws Throwable {
    DeleteTopicOptions deleteTopicOptionsModel = new DeleteTopicOptions.Builder()
      .topicName("testString")
      .build();
    assertEquals(deleteTopicOptionsModel.topicName(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteTopicOptionsError() throws Throwable {
    new DeleteTopicOptions.Builder().build();
  }
