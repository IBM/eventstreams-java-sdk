...
/**
 * Unit test class for the MirroringTopicSelection model.
 */
public class MirroringTopicSelectionTest {
  ...
  public void testMirroringTopicSelection() throws Throwable {
    ...
    MirroringTopicSelection mirroringTopicSelectionModelNew = TestUtilities.deserialize(json, MirroringTopicSelection.class);
    assertTrue(mirroringTopicSelectionModelNew instanceof MirroringTopicSelection);
  }
}