...
/**
 * Unit test class for the ListBrokersOptions model.
 */
public class ListBrokersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListBrokersOptions() throws Throwable {
    ListBrokersOptions listBrokersOptionsModel = new ListBrokersOptions();
    assertNotNull(listBrokersOptionsModel);
  }
}