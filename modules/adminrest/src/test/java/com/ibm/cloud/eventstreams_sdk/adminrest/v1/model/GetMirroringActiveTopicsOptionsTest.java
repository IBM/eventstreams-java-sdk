...
/**
 * Unit test class for the GetMirroringActiveTopicsOptions model.
 */
public class GetMirroringActiveTopicsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMirroringActiveTopicsOptions() throws Throwable {
    GetMirroringActiveTopicsOptions getMirroringActiveTopicsOptionsModel = new GetMirroringActiveTopicsOptions();
    assertNotNull(getMirroringActiveTopicsOptionsModel);
  }
}