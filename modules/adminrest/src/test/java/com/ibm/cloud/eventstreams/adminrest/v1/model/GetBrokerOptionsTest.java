...
/**
 * Unit test class for the GetBrokerOptions model.
 */
public class GetBrokerOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBrokerOptions() throws Throwable {
    GetBrokerOptions getBrokerOptionsModel = new GetBrokerOptions.Builder()
      .brokerId(Long.valueOf("26"))
      .build();
    assertEquals(getBrokerOptionsModel.brokerId(), Long.valueOf("26"));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetBrokerOptionsError() throws Throwable {
    new GetBrokerOptions.Builder().build();
  }
