...
/**
 * Unit test class for the GetTopicOptions model.
 */
public class GetTopicOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetTopicOptions() throws Throwable {
    GetTopicOptions getTopicOptionsModel = new GetTopicOptions.Builder()
      .topicName("testString")
      .build();
    assertEquals(getTopicOptionsModel.topicName(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetTopicOptionsError() throws Throwable {
    new GetTopicOptions.Builder().build();
  }
