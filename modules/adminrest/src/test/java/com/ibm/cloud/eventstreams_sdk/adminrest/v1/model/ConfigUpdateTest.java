...
/**
 * Unit test class for the ConfigUpdate model.
 */
public class ConfigUpdateTest {
  ...
  public void testConfigUpdate() throws Throwable {
    ...
    String json = TestUtilities.serialize(configUpdateModel);

    ConfigUpdate configUpdateModelNew = TestUtilities.deserialize(json, ConfigUpdate.class);
    assertTrue(configUpdateModelNew instanceof ConfigUpdate);
    assertEquals(configUpdateModelNew.name(), "testString");
    assertEquals(configUpdateModelNew.value(), "testString");
    assertEquals(configUpdateModelNew.resetToDefault(), Boolean.valueOf(true));
  }
}