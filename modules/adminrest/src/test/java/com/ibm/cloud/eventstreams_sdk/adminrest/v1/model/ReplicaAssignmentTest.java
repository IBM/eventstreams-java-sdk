...
/**
 * Unit test class for the ReplicaAssignment model.
 */
public class ReplicaAssignmentTest {
  ...
  @Test
  public void testReplicaAssignment() throws Throwable {
    ReplicaAssignment replicaAssignmentModel = new ReplicaAssignment();
    assertNull(replicaAssignmentModel.getId());
    assertNull(replicaAssignmentModel.getBrokers());
  }
}