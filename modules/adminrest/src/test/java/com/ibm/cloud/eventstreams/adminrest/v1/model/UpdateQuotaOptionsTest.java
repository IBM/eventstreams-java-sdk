...
public class UpdateQuotaOptionsTest {
  ...
  public void testUpdateQuotaOptions() throws Throwable {
    ...
    assertEquals(updateQuotaOptionsModel.consumerByteRate(), Long.valueOf("1024"));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateQuotaOptionsError() throws Throwable {
    new UpdateQuotaOptions.Builder().build();
  }
