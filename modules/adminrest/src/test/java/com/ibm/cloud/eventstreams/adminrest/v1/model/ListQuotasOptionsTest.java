...
/**
 * Unit test class for the ListQuotasOptions model.
 */
public class ListQuotasOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListQuotasOptions() throws Throwable {
    ListQuotasOptions listQuotasOptionsModel = new ListQuotasOptions();
    assertNotNull(listQuotasOptionsModel);
  }
}