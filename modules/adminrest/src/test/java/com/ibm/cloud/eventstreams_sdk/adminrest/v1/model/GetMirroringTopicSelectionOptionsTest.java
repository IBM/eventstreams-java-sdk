...
/**
 * Unit test class for the GetMirroringTopicSelectionOptions model.
 */
public class GetMirroringTopicSelectionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMirroringTopicSelectionOptions() throws Throwable {
    GetMirroringTopicSelectionOptions getMirroringTopicSelectionOptionsModel = new GetMirroringTopicSelectionOptions();
    assertNotNull(getMirroringTopicSelectionOptionsModel);
  }
}