...
/**
 * Unit test class for the GetClusterOptions model.
 */
public class GetClusterOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetClusterOptions() throws Throwable {
    GetClusterOptions getClusterOptionsModel = new GetClusterOptions();
    assertNotNull(getClusterOptionsModel);
  }
}