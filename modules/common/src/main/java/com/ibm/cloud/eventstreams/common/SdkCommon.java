...
// >>> Replace "eventstreams" with the correct value for your project
package com.ibm.cloud.eventstreams.common;
...
public class SdkCommon {
    ...
    // >>> Replace "eventstreams" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "eventstreams";
